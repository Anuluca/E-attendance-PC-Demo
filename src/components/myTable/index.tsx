...
interface TableProps {
  ...
  onSelectRow?: (arg0?: string[], arg1?: string[]) => void | null
...
const MyTable: FC<TableProps> = forwardRef(
  (props: TableProps, ref: RefType) => {
    ...
    const { results: tableData = [], total = -1 } = response || {}
    ...
    const resetAction = (page?: number): void => {
      ...
      const nextParams = page === 1 ? {} : { ...initParams, ...sortParams }
    ...
    useImperativeHandle(ref, () => ({
      ...
      update(page?: number): void {
        // console.log('searchh',searchForm)
        resetAction(page)
      },
      // 更新列表，并重置搜索字段
